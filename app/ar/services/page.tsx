      ...
      <div className="relative z-10 py-20 px-4">
        ...
        <div className="mb-20">
          ...
          <EgyptMap
            dots={[
              {
                start: { lat: 30.0444, lng: 31.2357 }, // القاهرة (المقر الرئيسي)
                end: { lat: 31.2001, lng: 29.9187, label: "الإسكندرية" },   // الإسكندرية
              },
              {
                start: { lat: 30.0444, lng: 31.2357 }, // القاهرة
                end: { lat: 27.2579, lng: 33.0, label: "الغردقة" },      // الغردقة (تم تحريكها للساحل)
              },
              {
                start: { lat: 30.0444, lng: 31.2357 }, // القاهرة
                end: { lat: 31.0409, lng: 31.3785, label: "العاصمة الإدارية" },   // العاصمة الإدارية الجديدة
              },
              {
                start: { lat: 30.0444, lng: 31.2357, label: "القاهرة" }, // القاهرة
                end: { lat: 30.0131, lng: 31.2089, label: "القاهرة الجديدة" },   // القاهرة الجديدة
              },
              {
                start: { lat: 30.0444, lng: 31.2357 }, // القاهرة
                end: { lat: 25.6872, lng: 32.6396, label: "الأقصر" },   // الأقصر
              },
            ]}
            lineColor="#d4af37"
          />
