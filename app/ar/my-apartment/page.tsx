...
export const metadata: Metadata = {
    title: 'شقتي - حاسبة التكلفة | بنيان مصر',
    description: 'احسب تكلفة تشطيب شقتك مع حاسبتنا الاحترافية. احصل على نطاق أسعار فوري للتشطيبات الاقتصادية والمتوسطة والفاخرة.',
