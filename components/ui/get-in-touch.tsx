...
export const ProfessionalConnect = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden relative w-full">
      {/* Animated Background */}
