...
export const AmbientColors: React.FC = () => {
    return (
        <div className="fixed inset-0 z-[1] pointer-events-none overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_12%_8%,rgba(90,159,212,0.12),transparent_34%),radial-gradient(circle_at_86%_22%,rgba(212,175,55,0.10),transparent_30%),radial-gradient(circle_at_65%_74%,rgba(139,92,246,0.08),transparent_38%)] md:hidden" />
