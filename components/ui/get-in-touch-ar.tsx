...
export const ProfessionalConnectAr = () => {
  ...
  const socialPlatforms = [
    ...
    },
    {
      ...
      shadowColor: 'rgba(59, 130, 246, 0.5)',
      link: 'https://www.facebook.com/profile.php?id=61586708520062',
      description: 'الشبكة الاجتماعية'
    },
    {
      name: 'إنستغرام',
      icon: (
      ...
      link: 'https://www.instagram.com/bonyanmisr.official/',
      description: 'القصص المرئية'
    },
    {
      name: 'تيك توك',
      icon: (
      ...
      link: 'https://www.tiktok.com/@bonyan.misr.official',
    ...
    },
    {
      ...
      link: 'mailto:info@bonyanmisr.com',
      description: 'راسلنا'
    }
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden relative w-full" dir="rtl">
      {/* Animated Background */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-200/30 via-transparent to-transparent dark:from-blue-900/20"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-purple-200/30 via-transparent to-transparent dark:from-purple-900/20"></div>
        {/* Animated Grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div>
        {/* Floating Orbs */}
        ...
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-purple-400/15 dark:bg-purple-600/20 rounded-full blur-[128px] animate-pulse delay-700"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8">
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-white/80 to-gray-100/80 dark:from-slate-800/50 dark:to-slate-900/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-300/50 dark:border-slate-700/50 overflow-hidden transition-all duration-500 hover:scale-105 hover:border-gray-400/50 dark:hover:border-slate-600/50">
                ...
                <div className="relative z-10">
                  ...
                  {/* Arrow Icon */}
                  <div className="mt-4 flex items-center text-gray-500 dark:text-gray-600 group-hover:text-gray-900 dark:group-hover:text-white transition-all duration-300">
                    <span className="text-sm font-medium group-hover:translate-x-0 transition-all duration-300">
                      تواصل
                    </span>
                    <svg className="w-4 h-4 mr-2 transform transition-transform duration-300 group-hover:-translate-x-1 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`mt-16 text-center transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <button className="group relative inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-white font-medium overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25">
            ...
            <svg className="w-4 h-4 relative z-10 transition-transform duration-300 group-hover:-translate-x-1 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
