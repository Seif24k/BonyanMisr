        ...
        >
          ...
          <h3 className="text-2xl font-bold text-white mb-4 relative inline-block">
            ...
            <motion.div
              ...
              className="absolute bottom-0 right-0 h-0.5 bg-gradient-to-l from-[#f5a623] to-[#d4af37]"
            />
          </h3>
...
export default function PremiumServicesSectionAr() {
  const services = [
    {
    ...
    },
    {
      ...
      description: 'إنشاء مساحات داخلية وظيفية وجمالية تعكس أسلوبك الشخصي.',
      link: '/ar/services',
    },
    {
      icon: <PaintBucket className="w-8 h-8" strokeWidth={1.5} />,
      title: 'التشطيبات',
      description: 'أعمال تشطيب فاخرة تشمل الأرضيات والدهانات والجبس والنجارة المخصصة.',
      link: '/ar/services',
    },
  ];
  ...
  return (
    <section className="relative py-24 px-4 overflow-hidden bg-transparent" dir="rtl">
      {/* Floating star dots */}
