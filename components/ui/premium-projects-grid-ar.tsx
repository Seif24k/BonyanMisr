...
interface Project {
  id: number;
  image: string;
  category: 'البناء' | 'التصميم' | 'خط النهاية' | 'ثلاثة في واحد' | 'التصميم الداخلي' | 'الإنشاءات' | 'الجودة';
  title: string;
}
...
const categoryIcons = {
  'البناء': HardHat,
  'التصميم': Palette,
  'خط النهاية': PaintBucket,
  'ثلاثة في واحد': HardHat,
  'التصميم الداخلي': Palette,
  'الإنشاءات': HardHat,
  'الجودة': PaintBucket,
};
...
const ProjectCard = ({ project, index }: { project: Project; index: number }) => {
  ...
  return (
    ...
    >
      <Link href={`/ar/project/${project.id}`}>
        <motion.div
          animate={{
              ...
              <div className="flex items-center gap-2 justify-end" dir="rtl">
                ...
                >
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                    className="absolute bottom-0 right-0 h-0.5 bg-[#f5a623] shadow-[0_0_8px_rgba(245,166,35,0.8)]"
                  />
                </span>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <ArrowRight className="w-4 h-4 text-[#f5a623] rotate-180" />
                </motion.div>
              </div>
            </div>
          </div>
...
export default function PremiumProjectsGridAr() {
  ...
  return (
    <section className="relative py-20 px-4 bg-transparent" dir="rtl">
      <div className="max-w-7xl mx-auto">
        <PremiumSectionHeader title="جميع المشاريع" className="mb-16" />
